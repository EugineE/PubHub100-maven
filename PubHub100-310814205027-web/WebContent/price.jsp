...
<!-- End Status -->
			...
			<form action="PriceController" method="get">
			<div id="contact-form" class="form-container" data-form-container>
			<div class="row">
				<div class="form-title">
					<span>Change Book Price</span>
				</div>
			</div>
			<div class="input-container">
				...
				<div class="row">
					<span class="req-input" >
						...
						<input type="text" data-min-length="8" placeholder="Book Name" name="name" list="data">
					</span>
				</div>
				
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input Your price."> </span>
						<input type="text" placeholder="Price" name="price">
					</span>
				</div>
				
				<div class="row submit-row">
					<button type="submit" class="btn btn-block submit-form">Rename</button>
				</div>
			</div>
			</div>
			<datalist id="data">
